 ...
 * <p/>
 *
 * @author Ekaterina Listener of menu item "Graph" Draw graph Value(t) by SWT lib
 */
public class GraphController implements SelectionListener
{
    ...
    /**
     * Converting 'time' and 'values' to the coordinate axes, Draws a graph for values of given object identifier
     *
