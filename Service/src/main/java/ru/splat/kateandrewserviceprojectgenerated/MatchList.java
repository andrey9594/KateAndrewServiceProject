 ...
 *       &lt;sequence>
 *         &lt;element name="match" type="{}matchEntryTCP" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "match_list")
public class MatchList {

    @XmlElement(required = true)
    protected List<MatchEntryTCP> match;
     ...
     * 
     */
    public List<MatchEntryTCP> getMatch() {
        if (match == null) {
            match = new ArrayList<MatchEntryTCP>();
        }
        return this.match;
    }
